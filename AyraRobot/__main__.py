...
buttons = [
    [
        InlineKeyboardButton(
            text="✗ ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ​ ✗", url="https://t.me/Miss_Ayra_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
